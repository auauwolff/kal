// Hand-curated "slug" foods (apple-fresh, banana-fresh, butter, ...) that
// originally lived only on dev. Synced to prod via `seedCuratedFoods`.
// Data dumped from dev on 2026-04-27.

import type { CuratedFood } from './curatedFoods';

export const slugFoods: CuratedFood[] = [
  {
    source: 'ausnut',
